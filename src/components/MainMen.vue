        ...
        <div class="relative flex items-center justify-between h-16">
          <div class="flex items-center px-2 lg:px-0">
            ...
            <div class="hidden lg:block lg:ml-6">
              <div class="flex space-x-4">
                ...
                <a
                  href="#"
                  class="bg-polar-gray text-white px-3 py-2 rounded-md text-sm font-extrabold font-heading-font"
                  >Products</a
                >
                <a
                  href="#"
                  class="text-black hover:bg-polar-red hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                  >Solutions</a
                >
                <a
                  href="#"
          ...
          <div class="hidden lg:block lg:ml-4">
            <div class="flex items-center">
              <i class="fab fa-facebook fa-xl mr-4"></i>
              <i class="fab fa-twitter fa-xl mr-4"></i>
