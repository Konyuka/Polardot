<template>
  <nav class="bg-black">
    <div class="max-w-9xl mx-auto px-2 sm:px-4 lg:px-8">
      <div class="relative flex items-center justify-between h-lg">
        <div class="flex items-center px-2 lg:px-0">
          <div class="flex-shrink-0 mt-8 mb-8">
            ...
            />
            <img
              class="hidden lg:block h-24 w-auto"
              src="@/assets/PolardotLogo.png"
              alt="Workflow"
            />
          </div>
        ...
        <div class="hidden lg:flex lg:ml-4 justify-between gap-20">
          ...
          <div class="flex items-center">
            ...
            <i class="fab fa-google text-white fa-2xl mr-6"></i>
            <i class="fab fa-linkedin text-white fa-2xl mr-6"></i>
          </div>
        </div>
      </div>
    </div>
