<template>
  <div>
    ...
    <div
      class="relative bg-polar-red pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8"
    >
      <div class="absolute inset-0">
        <div class="bg-polar-red h-1/3 sm:h-2/3"></div>
      </div>
      <div class="relative max-w-7xl mx-auto">
        <div class="text-center">
          ...
          <p class="mt-3 max-w-2xl mx-auto text-xl text-white sm:mt-4">
            Applications of Polardot 3D Survey Pro
          </p>
        </div>
        <div
