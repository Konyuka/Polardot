              ...
              <div class="ml-3 relative">
                <div>
                  <button
                    ...
                    type="button"
                    class="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-polar-red"
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
                  >
                    <span class="sr-only">Open user menu</span>
                    <i class="fas fa-cog text-polar-red fa-2x"></i>
                    <!-- <img
